...
MV2_USE_CUDA=1 MV2_ENABLE_AFFINITY=0 MV2_SMP_USE_CMA=0 srun \
    ...
    --train_dir=/mnt/lustre/liukunlin/caad/alp/pgd-image-299-newtry_normal \
    --trainable_scopes="resnet_v2_50/logits,resnet_v2_50/postnorm" \
    --dataset=imagenet \
    --dataset_image_size=299 \
    --adv_method=pgdll_32_10_50 \
    --hparams="eval_batch_size=50" \
    --eval_once=True \
    --imagenet_data_dir="/mnt/lustre/liukunlin/caad/alp/imagenet-tfrecord" 2>&1 | tee 8-17log_${TIMESTAMP} &
