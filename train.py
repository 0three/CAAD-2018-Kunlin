...
def main(_):
  ...
  tf.logging.info('%s',tf.__version__)
  ...
  with graph.as_default():
	...
	adv_logits = model_fn(adv_examples, is_training=True)
	adv_one_hot_labels = one_hot_labels
...
#	adv_images1, adv_images2 = tf.split(adv_logits, 2)
#	loss_adv =tf.losses.mean_squared_error(
#	    adv_images1,adv_images2,weights=params.train_lp_weight)
